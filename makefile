...
fuses:
	...
	@if [ -e /dev/ttyACM0 ]; then\
		avrdude -c avrisp -p m328p -b 19200 -P /dev/ttyACM0 -U lfuse:w:0xd0:m -U efuse:w:0xff:m -U hfuse:w:0xd9:m; else\
		avrdude -c avrisp -p m328p -b 19200 -P /dev/ttyACM1 -U lfuse:w:0xd0:m -U efuse:w:0xff:m -U hfuse:w:0xd9:m; fi
